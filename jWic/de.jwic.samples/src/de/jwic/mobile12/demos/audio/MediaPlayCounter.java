 ...
 */
@JavaScriptSupport
public class MediaPlayCounter extends InputBox {
	 ...
	 */
	public MediaPlayCounter(IControlContainer container) {
		super(container);
	}
	 ...
	 */
	public MediaPlayCounter(IControlContainer container, String name) {
