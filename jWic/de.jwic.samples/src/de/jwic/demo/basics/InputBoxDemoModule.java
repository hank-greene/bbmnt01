	...
	public void createModule(IControlContainer container) {
		...
		inptBox.addKeyListener(new KeyListener() {
			...
			public void keyPressed(KeyEvent event) {
				...
				System.out.println("Key pressed for InputBox with listen key code " + inptBox.getListenKeyCode());
			}
		});
		...
		numInp.addKeyListener(new KeyListener() {
			...
			public void keyPressed(KeyEvent event) {
				...
				System.out.println("Key pressed for NumericInputBox with listen key code " + numInp.getListenKeyCode());
			}
		});
